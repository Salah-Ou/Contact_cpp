...
void Contact::show_contacts(){
    ...
    if (!info.empty()){
        ...
        for (auto& info : info){
            cout << "\n\t  \033[1;34m--------------------------------------" ;
            cout << "\n\t\t\033[1;3;34mName           : \033[37m" << info.name ;
            cout << "\n\t\t\033[1;3;34mPhone Number   : \033[37m" << info.phone_no ; 
            cout << "\n\t\t\033[1;3;34mAdress         : \033[37m" << info.adress ; 
            cout << "\n\t\t\033[1;3;34mEmail          : \033[37m" << info.email ; 
            cout << "\n\t\t\033[1;3;34mPassword Email : \033[37m" << info.password ;
            cout << "\n\t  \033[1;34m--------------------------------------\033[0m\n" ;
        }
        cout << "\033[1;33m\n\t     " ;
        system("pause");
